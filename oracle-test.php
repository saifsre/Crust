...
size="18"><input type="text" name="insAge" size="6">
...
<p> Update the age by inserting the old and new values below: </p>
<p><font size="2"> Old Age&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
New Age</font></p>
<form method="POST" action="oracle-test.php">
<!--refresh page when submit-->

   <p><input type="text" name="oldAge" size="6"><input type="text" name="newAge" 
size="18">
<!--define two variables to pass the value-->
...
$db_conn = OCILogon("ora_w4o0b", "a43768150", "dbhost.ugrad.cs.ubc.ca:1522/ug");
	...
	if (array_key_exists('reset', $_POST)) {
		...
		if (array_key_exists('insertsubmit', $_POST)) {
			...
			if (array_key_exists('updatesubmit', $_POST)) {
				...
				executeBoundSQL("update tab1 set age=:bind2 where age=:bind1", $alltuples);
				OCICommit($db_conn);

			} else
				if (array_key_exists('dostuff', $_POST)) {
					// Insert data into table...
					executePlainSQL("insert into tab1 values (10, 'Frank', 21)");
